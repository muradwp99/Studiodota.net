        ...
        <div className="shell grid gap-14 lg:grid-cols-[1.35fr_0.85fr] lg:gap-20">
          <Reveal>
            <div className="card-grad p-6 md:p-10">
              <span className="eyebrow eyebrow--plain">{d.formLabel}</span>
          ...
          <Reveal delay={120}>
            <aside className="space-y-10 lg:sticky lg:top-28">
              <div>
                <h3 className="eyebrow eyebrow--sheet">Direct</h3>
              ...
              <div>
                <h3 className="eyebrow eyebrow--sheet">What to send</h3>
                <p className="mt-5 text-[var(--muted)]">{d.whatToSend}</p>
              </div>
              <div>
                <h3 className="eyebrow eyebrow--sheet">Turnaround</h3>
