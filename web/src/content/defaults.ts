...
export const BLOCK_DEFAULTS = {
  ...
  "home.process": {
    ...
    steps: [
      /* Not office-san-diego/02: that file does not exist (the set is 01, 03-07),
         so this step rendered a broken image whenever the defaults were in play
         - a DB-down fallback or a fresh seed. The live row already carries a
         valid path; this is the fallback catching up, and it avoids the rest of
         that low-resolution set. */
      { n: "01", title: "Consultation", body: "We start by understanding your brief, references, and goals in a focused kickoff.", image: P("garments-office", 1) },
  ...
  taxonomies: {
    ...
    /* Must match CATEGORY_LABELS in src/lib/projectCategories.ts — this list
       is the admin's category dropdown, that one is the public filter bar. They
       had drifted: "fire-rebuild" could not be picked in the admin at all, and
       "office" was selectable but had no filter, so anything filed under it was
       unreachable from /projects. */
    projectCategories: [
      "affordable-housing", "single-family", "multifamily", "mixed-use",
      "fire-rebuild", "commercial", "senior-living", "adu", "interior",
    ] as string[],
...
export const SEED_PROJECTS = [
  ...
  { slug: "fire-rebuild-mckendree-01", title: "Mckendree 01", summary: "A fire-rebuild residence in Pacific Palisades - currently in design; renders to follow.", category: "fire-rebuild", sector: "Fire Rebuild", location: "Pacific Palisades, CA", year: "2025", services: ["Architectural Design"], heroImage: P("fire-rebuild-mckendree-01", 1), interiorImage: P("fire-rebuild-mckendree-01", 2), gallery: G("fire-rebuild-mckendree-01", 4), published: true, sort: 4 },
  { slug: "fire-rebuild-mckendree-02", title: "Mckendree 02", summary: "A fire-rebuild residence in Pacific Palisades - currently in design; renders to follow.", category: "fire-rebuild", sector: "Fire Rebuild", location: "Pacific Palisades, CA", year: "2025", services: ["Architectural Design"], heroImage: P("fire-rebuild-mckendree-02", 1), interiorImage: P("fire-rebuild-mckendree-02", 2), gallery: G("fire-rebuild-mckendree-02", 3), published: true, sort: 5 },
  { slug: "fire-rebuild-aiglon-house", title: "Aiglon House", summary: "A Pacific Palisades fire rebuild - a contemporary residence stepped into its garden, studied from the street approach, the front elevation, and the rear terraces.", category: "fire-rebuild", sector: "Fire Rebuild", location: "Pacific Palisades, CA", year: "2025", services: ["Architectural Design", "3D Visualization"], heroImage: P("fire-rebuild-aiglon-house", 1), interiorImage: P("fire-rebuild-aiglon-house", 3), gallery: G("fire-rebuild-aiglon-house", 3), published: true, sort: 9 },
  { slug: "fire-rebuild-kagawa-st", title: "Kagawa St", summary: "A fire-rebuild residence in Pacific Palisades - currently in design; renders to follow.", category: "fire-rebuild", sector: "Fire Rebuild", location: "Pacific Palisades, CA", year: "2025", services: ["Architectural Design"], heroImage: PLACEHOLDER, interiorImage: "", gallery: [] as string[], published: false, sort: 6 },
  { slug: "fire-rebuild-temecula", title: "Temecula", summary: "A fire-rebuild residence - currently in design; renders to follow.", category: "fire-rebuild", sector: "Fire Rebuild", location: "Pacific Palisades, CA", year: "2025", services: ["Architectural Design"], heroImage: PLACEHOLDER, interiorImage: "", gallery: [] as string[], published: false, sort: 7 },
  ...
  { slug: "studio-apartment-158", title: "Studio Apartment - 158 Units", summary: "A 158-unit studio apartment development - stacked blocks studied from every street corner.", category: "multifamily", sector: "Multifamily", location: "", year: "2022", services: ["Architectural Design"], heroImage: P("studio-apartment-158", 1), interiorImage: P("studio-apartment-158", 3), gallery: G("studio-apartment-158", 5), published: true, sort: 17 },
