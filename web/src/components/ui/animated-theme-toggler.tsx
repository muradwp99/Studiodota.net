...
interface AnimatedThemeTogglerProps extends React.ComponentPropsWithoutRef<"button"> {
  ...
  /** Icon markup - no built-in default, so callers aren't forced onto a specific icon set. */
...
export const AnimatedThemeToggler = ({
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      setInternalIsDark(document.documentElement.dataset.theme === "dark")
    }
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      // Always set this synchronously so the View Transitions API snapshots
      // the new theme inside the startViewTransition callback. This site
      // themes off [data-theme], not a "dark" class.
